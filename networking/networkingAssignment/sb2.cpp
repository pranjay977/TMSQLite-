...
char g,responseBuffer[1025],requestBuffer[8183];
...
bytesExtracted=recv(clientSocketDescriptor,requestBuffer,8183,0);
if(bytesExtracted<0)
{
...
{
//###################################################### SOLUTION OF BUG
sprintf(temp,"<DOCKTYPE HTML><html lang='en'><head><meta charset='utf-8'><title>Good website</title></head><body>RESPONSE NOT FOUND</body></html>");
